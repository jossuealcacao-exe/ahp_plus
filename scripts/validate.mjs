...
const required = [
  ...
  'src/live.mjs',
  'src/identity.mjs',
  'src/secure-relay.mjs',
  'src/secure-network.mjs',
  'src/hub.mjs',
  'src/upgrade.mjs',
  ...
  'schemas/relay-receipt.schema.json',
  'schemas/device-identity.schema.json',
  'schemas/secure-envelope.schema.json',
  'schemas/secure-receipt.schema.json',
  'docs/CONFORMANCE.md',
  'docs/GETTING_STARTED_ES.md',
  'docs/OPERATIONS_ES.md',
  'docs/LIVE_INTEROP_ES.md',
  'docs/WHY_AHP_ES.md',
